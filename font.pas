...
var
  FontData: array[0..255, 0..15] of Byte = (
    ($00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00),
    ($00, $7E, $81, $BD, $A5, $BD, $A1, $A1, $A1, $81, $7E, $00, $00, $00, $00, $00),
    ($00, $54, $38, $D6, $BA, $28, $FE, $A6, $A6, $BE, $28, $D6, $38, $54, $00, $00),
    ($00, $3C, $42, $42, $7E, $42, $42, $00, $18, $0C, $FE, $0C, $18, $00, $00, $00),
    ($00, $7E, $81, $A3, $B7, $AB, $A3, $A3, $A3, $81, $7E, $00, $00, $00, $00, $00),
    ($00, $00, $00, $C0, $60, $30, $60, $C0, $00, $00, $0F, $0F, $00, $00, $00, $00),
    ($00, $3C, $66, $C0, $C0, $C0, $66, $3C, $00, $00, $00, $00, $00, $00, $00, $00),
    ($00, $3C, $46, $46, $3C, $04, $3C, $44, $44, $3C, $00, $00, $00, $00, $00, $00),
    ($00, $7E, $42, $7A, $0A, $7A, $7E, $00, $00, $00, $00, $00, $00, $00, $00, $00),
    ($00, $3C, $66, $C0, $DC, $C4, $66, $3C, $00, $00, $00, $00, $00, $00, $00, $00),
    ($00, $24, $48, $90, $48, $24, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00),
    ($00, $24, $FF, $24, $FF, $24, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00),
    ($00, $10, $3C, $50, $3C, $14, $3C, $10, $00, $00, $00, $00, $00, $00, $00, $00),
    ($00, $C6, $EE, $BA, $92, $10, $38, $10, $00, $00, $00, $00, $00, $00, $00, $00),
    ($00, $18, $24, $20, $10, $20, $24, $18, $00, $00, $00, $00, $00, $00, $00, $00),
    ($00, $C3, $66, $3C, $18, $18, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00),
    ($00, $7C, $44, $44, $44, $7C, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00),
...
procedure DrawCharASM(Dest: Pointer; Pitch, X, Y: Integer; C: Byte; Color: LongWord);

implementation

procedure DrawCharASMRaw(Dest: Pointer; Pitch, X, Y: Integer; C: Byte; Color: LongWord); assembler; nostackframe;
asm
    // Dest in rdi, Pitch in rsi, X in rdx, Y in rcx, C in r8b, Color in r9d
    // Calculate GlyphPtr: FontData + C * 16
    lea r10, [FontData]
    movzx r8d, r8b
    shl r8d, 4
    add r10, r8
    
    // Calculate target address: Dest + Y * Pitch + X * 4
    imul rcx, rsi
    add rdi, rcx
    shl rdx, 2
    add rdi, rdx
...
procedure DrawCharASM(Dest: Pointer; Pitch, X, Y: Integer; C: Byte; Color: LongWord);
begin
  if (Dest = nil) or (X < 0) or (Y < 0) or (X + 8 > Pitch div 4) or (Y + 16 > 2000) then Exit;
  DrawCharASMRaw(Dest, Pitch, X, Y, C, Color);
end;
